...
namespace Behavior.Controllers
{
    public class FeelingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] Feeling feeling)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Feeling feeling)
        {
            if (id != feeling.Id)
            {
                return NotFound();
