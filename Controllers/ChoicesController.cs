...
namespace Behavior.Controllers
{
    public class ChoicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] Choice choice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Choice choice)
        {
            if (id != choice.Id)
            {
                return NotFound();
