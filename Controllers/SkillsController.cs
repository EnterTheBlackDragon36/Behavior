...
namespace Behavior.Controllers
{
    public class SkillsController : Controller
    {
        ...
        public SkillsController(BehaviorContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [FromBody] Skill skill)
        {
            if (id != skill.Id)
            {
                return NotFound();
