...
namespace Behavior.Controllers
{
    public class ActivitiesController : Controller
    {
        ...
        public ActivitiesController(BehaviorContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        [Route("api/Activities/Details/{id}")]
        ...
        [Route("api/Activities/Create/{Activity}")]
