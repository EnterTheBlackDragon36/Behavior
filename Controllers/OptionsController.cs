...
namespace Behavior.Controllers
{
    public class OptionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] Option option)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Option option)
        {
            if (id != option.Id)
            {
                return NotFound();
